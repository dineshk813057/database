...
try:
    con=pm.connect(host="localhost",database="user",user="root",password="dineshkar@@")
    ...
    query11="insert into authors07 values(1,'himant','chand','sharma')"
    ...
    query13="update authors07 set last_name='kar' where author_id=1"
